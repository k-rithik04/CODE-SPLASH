...
export default function HackathonRegistration() {
  ...
  // Initialize comprehensive form state
  const [formData, setFormData] = useState({
    // STEP 1
    registrationType: "", // "Individual" or "Team"
    
    // INDIVIDUAL PATH & COMMON
    fullName: "",
    gender: "",
    email: "",
    phone: "",
      ...
      <div className="container mx-auto max-w-3xl py-10 px-4">
        ...
        <Card className="bg-black/70 backdrop-blur-md border-neutral-800 shadow-2xl">
          <form onSubmit={handleSubmit}>
            ...
            {formData.registrationType === "Team" && step === 4 && (
              <>
                ...
                <CardContent className="space-y-8">
                  {/* Loop based on team size minus 1 (for the leader) */}
            ...
            {/* --- SHARED: TECHNICAL SKILLS (Step 3 Indiv / Step 5 Team) --- */}
            ...
            {/* --- SHARED: INNOVATION & PROBLEM SOLVING (Step 4 Indiv / Step 6 Team) --- */}
            ...
            {/* --- SHARED: DECLARATION (Step 5 Indiv / Step 7 Team) --- */}
