...
export default function SchoolRegistrationPage() {
  /* ──────────────────────────────────────────────
   *  IFRAME METHOD — all original logic commented out below
   * ────────────────────────────────────────────── */
    ...
    >
      <div className="container mx-auto max-w-3xl py-10 px-4">
        ...
        <Card className="bg-black/70 backdrop-blur-md border-neutral-800 shadow-2xl">
          <CardHeader>
            <CardTitle className="text-2xl text-white-500 text-center">
              School Registration — CodeSplash 2026
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0 overflow-hidden">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSdDPajTF-UsQieALRZbrIpqjyL0wPReSATrBeXMG_QkNF7gBQ/viewform?embedded=true"
              className="w-full"
              style={{ height: "2569px", border: "none" }}
  ...
  /* ──────────────────────────────────────────────
   *  ORIGINAL MULTI-STEP FORM (commented out)
   * ────────────────────────────────────────────── */
