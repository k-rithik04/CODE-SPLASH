...
const FIELDS = [
  { key: "logo_url", label: "Logo URL", type: "text" as const, placeholder: "/CodeSplash.png" },
  ...
  { key: "cta_button_link", label: "CTA Button Link", type: "text" as const, placeholder: "/register" },
