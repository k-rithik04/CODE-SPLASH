...
const NAV_GROUPS: NavGroup[] = [
  {
    label: "Content",
    items: [
      { label: "Chapters", href: "/cms/content/chapters", icon: "M4 6h16M4 12h16M4 18h7" },
      { label: "Prizes", href: "/cms/content/prizes", icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" },
      { label: "Timeline", href: "/cms/content/timeline", icon: "M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" },
      { label: "Partners", href: "/cms/content/partners", icon: "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" },
      { label: "Team", href: "/cms/content/team", icon: "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2M12 11a4 4 0 100-8 4 4 0 000 8z" },
      { label: "FAQ", href: "/cms/content/faq", icon: "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM9 9h.01M15 9h.01M9.5 15a3.5 3.5 0 015 0" },
    ],
  },
  {
    label: "Settings",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Audit Log", href: "/cms/audit", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
    ],
  },
];
