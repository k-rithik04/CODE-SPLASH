...
interface CanvasBackgroundProps {
  ...
  partCanvasRef: RefObject<HTMLCanvasElement | null>;
  canvasWrapperRef: RefObject<HTMLDivElement | null>;
}

export default function CanvasBackground({ bgCanvasRef, partCanvasRef, canvasWrapperRef }: CanvasBackgroundProps) {
  return (
    <div
