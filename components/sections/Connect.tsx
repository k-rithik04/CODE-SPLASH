    ...
    >
      <div className="w-full flex-1 flex flex-col items-center justify-end px-[5%] pb-[100px] relative mt-[10vh]">
        ...
        <div className="w-full flex justify-center mb-4">
          <Image src={data?.cssa_logo_url ? getStorageUrl(data.cssa_logo_url) : "/CSSALogo.png"} alt="CSSA Logo" width={250} height={80} unoptimized className="max-w-[200px] md:max-w-[250px] h-auto object-contain opacity-90" style={{ height: "auto" }} />
        </div>
