...
CREATE TABLE hero_content (
  id INT PRIMARY KEY DEFAULT 1,
  logo_url TEXT NOT NULL DEFAULT '/assets/CodeSplash.webp',
...
CREATE TABLE connect_content (
  ...
  cssa_logo_url TEXT NOT NULL DEFAULT '/assets/CSSALogo.webp',
...
('University Phase', 'Pharaoh''s Legacy Prize', 'Awarded to the university team that demonstrates exceptional innovation, technical excellence and teamwork while conquering the toughest challenges on the journey to victory.', 'LKR 150,000', 1),
('School Phase', 'Rising Explorer''s Prize', 'Celebrating young innovators who showcase outstanding creativity, determination and problem-solving skills as they take their first steps toward greatness.', 'LKR 100,000', 2),
('Agentic AI Challenge', 'Artisan of the Nile Award', 'Recognizing the innovators who build intelligent AI agents that solve real-world challenges through creativity, autonomy and technical excellence.', 'LKR 50,000', 3);

INSERT INTO timeline_entries (date, title, description, position, is_current, sort_order) VALUES
('Feb 01', 'Inception', 'CodeSplash reveal.', 'left', false, 1),
('Feb 16', 'Registrations Open', 'Form your squad.', 'right', false, 2),
('Feb 23', 'Teams Growing', 'Institution list grows.', 'left', false, 3),
('Mar 01', 'Entries Close', 'Gates close.', 'right', false, 4),
('Mar 03', 'Preliminary Prep', 'Mentors assign.', 'left', false, 5),
('Mar 05', 'Prelims Kick-off', 'Hacking starts.', 'right', true, 6),
('Mar 15', 'Prelims Judging', 'Experts evaluate.', 'left', false, 7),
('Mar 20', 'Finalists Revealed', 'Top teams advance.', 'right', false, 8),
('Mar 22', 'Finalist Mentorship', 'Intensive sessions.', 'left', false, 9),
('Mar 26', 'Finalist Submission', 'Last polish.', 'right', false, 10),
('Mar 27', 'Grand Finale Prep', 'Last checklists.', 'left', false, 11),
('Mar 28', 'Grand Finale', '24-hour hackathon.', 'center', false, 12);

INSERT INTO partners (category, name, logo_url, sort_order) VALUES
('platinum', 'Gen ALPHA', '/assets/logos/GenerationAlpha.webp', 1),
('platinum', 'Slasscom', '/assets/logos/Slasscom.webp', 2),
('platinum', 'ictfromabc', '/assets/logos/ictfromabc1.webp', 3),
('school_platinum', 'Gen ALPHA', '/assets/logos/GenerationAlpha.webp', 1),
('knowledge', 'Slasscom', '/assets/logos/Slasscom.webp', 1),
('knowledge', 'ictfromabc', '/assets/logos/ictfromabc1.webp', 2);
...
('What is the required team size?', 'Teams must consist of 3 to 5 members from the same institution.', 1),
('Is there a registration fee?', 'No, registration is completely free for all eligible students.', 2),
('Will accommodation be provided?', 'Yes, food and rest areas are provided for Top 20 finalists on-site.', 3),
('Can I participate in multiple tracks?', 'No, you may only register for one specific track to keep things fair.', 4),
('Who owns the IP of the final product?', 'The intellectual property remains entirely with the creators.', 5),
('What tech stack should we use?', 'You are free to use any languages, frameworks, or cloud platforms.', 6),
('Are we allowed to use AI tools like Copilot?', 'Yes, standard assistants are allowed, but blind copy-pasting is discouraged.', 7);

INSERT INTO cta_content (id, heading, button_text, button_link)
VALUES (1, 'Ready to dive in?', 'Register Now', '/register');
